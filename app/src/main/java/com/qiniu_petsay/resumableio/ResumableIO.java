package com.qiniu_petsay.resumableio;
...
import com.qiniu_petsay.auth.Client;
import com.qiniu_petsay.auth.JSONObjectRet;
import com.qiniu_petsay.utils.ICancel;
...
public class ResumableIO {
	com.qiniu_petsay.resumableio.ResumableClient mClient;
	...
	public ResumableIO(String uptoken) {
		mClient = new com.qiniu_petsay.resumableio.ResumableClient(Client.getMultithreadClient(), uptoken);
	}
	public ResumableIO(com.qiniu_petsay.resumableio.ResumableClient client) {
		mClient = client;
	}
	...
	private int putAndClose(final String key, final InputStreamAt input, final com.qiniu_petsay.resumableio.PutExtra extra, final JSONObjectRet ret) {
	...
	public int put(final String key, final InputStreamAt input, final com.qiniu_petsay.resumableio.PutExtra extra, final JSONObjectRet ret) {
	...
	public int putFile(String key, File file, com.qiniu_petsay.resumableio.PutExtra extra, final JSONObjectRet ret) {
		return putAndClose(key, InputStreamAt.fromFile(file), extra, ret);
	}

	public int putFile(Context mContext, String key, Uri uri, com.qiniu_petsay.resumableio.PutExtra extra, final JSONObjectRet ret) {
	...
	public static ResumableIO defaultInstance(String uptoken) {
		return new ResumableIO(new com.qiniu_petsay.resumableio.ResumableClient(Client.getMultithreadClient(), uptoken));
	}

	public static int putAndClose(String uptoken, String key, InputStreamAt isa, com.qiniu_petsay.resumableio.PutExtra extra, JSONObjectRet ret) {
		return ResumableIO.defaultInstance(uptoken).putAndClose(uptoken, key, isa, extra, ret);
	}

	public static int put(String uptoken, String key, InputStreamAt isa, com.qiniu_petsay.resumableio.PutExtra extra, JSONObjectRet ret) {
		return ResumableIO.defaultInstance(uptoken).put(key, isa, extra, ret);
	}

	public static int putFile(Context mContext, String uptoken, String key, Uri uri, com.qiniu_petsay.resumableio.PutExtra extra, JSONObjectRet ret) {
