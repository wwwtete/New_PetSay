...
import com.qiniu_petsay.utils.Base64;
import com.qiniu_petsay.utils.QiniuException;

public class ResumableClient extends com.qiniu_petsay.auth.Client {
	String mUpToken;
	...
	public ICancel[] putblock(final com.qiniu_petsay.utils.InputStreamAt input, final PutExtra extra, final PutRet putRet, final long offset, final JSONObjectRet callback) {
	...
	public ICancel mkblk(final com.qiniu_petsay.utils.InputStreamAt input, final long offset, final int blockSize, final int writeSize, final CallRet ret) {
	...
	public ICancel bput(String host, com.qiniu_petsay.utils.InputStreamAt input, String ctx, long blockOffset, long offset, int writeLength, CallRet ret) {
