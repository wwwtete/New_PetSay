 ...
 * 用户积分列表
 */
public class PetScoreAdapter extends ExBaseAdapter<PetScoreDetailVo> {


    public PetScoreAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PetScoreDetailVo vo = (PetScoreDetailVo) getItem(position);
