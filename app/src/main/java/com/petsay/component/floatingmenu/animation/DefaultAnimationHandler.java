 ...
 */
package com.petsay.component.floatingmenu.animation;
 ...
 * Animates translation, rotation, scale and alpha at the same createTime using Property Animation APIs.
 */
public class DefaultAnimationHandler extends MenuAnimationHandler {
    ...
    public DefaultAnimationHandler(boolean rotationEnable) {
    ...
    public void animateMenuOpening(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            PropertyValuesHolder pvhR = null;
            if(rotationEnable)
                    pvhR = PropertyValuesHolder.ofFloat(View.ROTATION, 720);
            ...
            if(rotationEnable)
                animation = ObjectAnimator.ofPropertyValuesHolder(menu.getSubActionItems().get(i).view, pvhX, pvhY, pvhR, pvhsX, pvhsY, pvhA);
            else
                animation = ObjectAnimator.ofPropertyValuesHolder(menu.getSubActionItems().get(i).view, pvhX, pvhY, pvhsX, pvhsY, pvhA);
