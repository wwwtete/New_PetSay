 ...
 */
package com.petsay.component.floatingmenu;
...
public class SubActionButton extends FrameLayout {
    ...
    public static final int THEME_NOMAL = -1;
...
//        }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.TOP | Gravity.LEFT);
            setLayoutParams(params);
            setTheme(SubActionButton.THEME_NOMAL);
        }
