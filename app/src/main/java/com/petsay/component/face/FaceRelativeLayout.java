...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	private boolean isShowingFace=false;
...
//				isShowingFace=false;
//				
//				btn_face.setImageResource(R.drawable.selectface);
//				
//				view.setVisibility(View.GONE);
//				PublicMethod.openSoftKeyBoard(et_sendmessage, 0);
//				
//			}else {
//				isShowingFace=true;
//				//点击显示键盘
...
//				
//				//点击显示表情
//				PublicMethod.closeSoftKeyBoard(context,et_sendmessage);
...
//			}
	...
	private void Init_View() {
		...
		btn_face.setImageResource(R.drawable.selectface);
		btn_face.setTag(R.drawable.selectface);
//		faceView.setVisibility(View.GONE);
	...
	private void faceShow() {
		...
		if (null != btn_face) {
			int id = (Integer) btn_face.getTag();
			if (id == R.drawable.selectface) {
				btn_face.setImageResource(R.drawable.keyboard);
				btn_face.setTag(R.drawable.keyboard);
				...
				btn_face.setImageResource(R.drawable.selectface);
				btn_face.setTag(R.drawable.selectface);
				if (curTat == BIGGER && et_sendmessage.isFocused()
						&& view.getVisibility() == View.VISIBLE) {// 焦点在msgEdit上，且软键盘是隐藏的
																		// 且faceView是可见的
					changeInput();
				} else {
	...
	public void setFaceVisible(boolean show) {
		if (null != view && null != btn_face) {
			int id = (Integer) btn_face.getTag();
			if (show && id == R.drawable.keyboard) {
				view.setVisibility(View.VISIBLE);
	 ...
	 * @param tagBtn
	 */
	private void onlyChangeFaceBtn(boolean tagBtn){
		if (null != btn_face) {
			if (!tagBtn) {
				btn_face.setImageResource(R.drawable.selectface);
				btn_face.setTag(R.drawable.selectface);
